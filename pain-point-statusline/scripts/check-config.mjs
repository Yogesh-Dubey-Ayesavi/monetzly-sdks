...
// ~/.pain-point-statusline/config.json), inject a quiet instruction telling
...
console.log(
  JSON.stringify({
    hookSpecificOutput: {
      ...
      additionalContext: [
        "pain-point-statusline: no Monetzly API key is configured yet, so ad fetching is disabled (the plugin still tracks pain points, just without ads).",
